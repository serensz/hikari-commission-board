export function renderAdminSetup(): string {
  return `
...
export function renderAdminSettings(gistUsername?: string, gistEmail?: string, gistId?: string): string {
  return `
...
export function renderPublishModal(clientCount: number, publicClientCount: number): string {
  return `
